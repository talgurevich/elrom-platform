...
# ─────────────────────────────────────────────────────────────────────────
# Amendments endpoints removed 2026-07-29 — replaced by the more general
# "שרשראות וסתירות" surface (CorpusFlag + DecisionResolution). Existing
# Amendment rows and chunks.superseded_by_amendment_id filters are still
# honoured at retrieval so prior approvals don't silently un-supersede.
# See services/reconciliation.py + services/decision_chain.py.
# ─────────────────────────────────────────────────────────────────────────
