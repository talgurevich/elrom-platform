...
2ג. מסמך רקע (background) או הזמנה (invitation) מול מסמך מאושר: מידע מול נורמה איננו סתירה — סווג consistent. חריג יחיד: שני מסמכי רקע שמדווחים נתונים עובדתיים סותרים על אותו עניין (למשל שני דוחות עם מספרים שונים) — זו contradicts.
