...
> תשובה: "מדובר בפרוטוקול אסיפת חברים מ-5.7.2016 בקיבוץ אל-רום. נכחו 28 מתוך 130 חברי האגודה; יו"ר האסיפה: עפר לין, נבחר גם אלון יפה כמזכיר, יוסף אורן כיו"ר ההנהלה הכללית. סדר היום כלל: [הפריטים שמופיעים בקטעים]."
